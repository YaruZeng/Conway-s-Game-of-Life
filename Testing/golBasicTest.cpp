...
TEST_CASE("Test1 for instantiation of class Status", "[Defualt]")
{
  ...
  //Test class methods by 2 instances
  ...
  REQUIRE_THROWS(s1.StatusGet(6, 5) == "o");
  REQUIRE_THROWS(s2.StatusGet(-1, 5) == "o");
  REQUIRE_THROWS(s1.StatusGet(7, 8) == "o");
  REQUIRE_THROWS(s2.StatusSet(-1, 0, "o"));
  REQUIRE_THROWS(s1.StatusSet(6, 5, "o"));
  REQUIRE_THROWS(s2.StatusSet(8, 8, "o"));
}
...
{
  //Consistency check between data loaded directly from the input file
  //and data stored in the class from the same file
  ...
  //Test for failure to read file

  REQUIRE_THROWS(gol::Status("Txt not exist.txt"));
}


TEST_CASE("Test for Method of class Status", "[Neighbouring Alive Count]")
{
  //Test for status generated by random method
  ...
  //Test for status generated by giving input file
  ...
  REQUIRE_THROWS(s2.NeighAlive(-1, 0));
  REQUIRE_THROWS(s1.NeighAlive(44, 55));
  REQUIRE_THROWS(s2.NeighAlive(10, 10));
  REQUIRE_THROWS(s1.NeighAlive(-8, -5));
}


TEST_CASE("Test1 for Game of Life", "[TakeStep]")
{
  //Set initial status of a grid
  ...
  //Test for result of the first iteration
  ...
  //Test for result of the second iteration
  ...
  //Test for result of the third iteration
